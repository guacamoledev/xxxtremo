  ...
  return (
    <Layout>
      ...
      <Typography variant="body2" paragraph sx={{ pl: 2 }}>
        a. Estos Términos y Condiciones;<br />
        b. Política de Privacidad;<br />
        c. Las reglas que aplican a cada juego de casino pueden ser encontradas dentro de cada juego de casino, e incluye la ganancia máxima disponible para cada juego ("Reglas de Juego");<br />
        d. Cualquier condición específica que se indique como aplicable (por ejemplo, si está ingresando a una promoción, los términos y condiciones de la promoción); y<br />
        e. Todos los demás términos y condiciones, reglas o políticas que se relacionan con las promociones de servicios aplicables; bonificaciones, ofertas especiales o cualquier otro aspecto de su uso de los servicios, considerándose para todos los efectos aplicables que usted ha aceptado y comprendido los mismos.<br />
      </Typography>
      <Typography variant="body2" paragraph>
      ...
      <Typography variant="body2" paragraph sx={{ pl: 2 }}>
        a. Tiene al menos 18 años. Nos reservamos el derecho de solicitar documentación para verificar la edad a cualquier solicitante o cliente en cualquier momento, y anularemos cualquier transacción realizada por menores de edad;<br />
        b. Proporcionará información verdadera al abrir su cuenta, que incluirá datos tales como su fecha de nacimiento, junto con una identificación válida que lo respalde, su país de residencia, su domicilio actual, dirección de correo electrónico, número de teléfono personal, entre otros. Debe informarnos de cualquier cambio en estos detalles;<br />
        c. Cuenta con la capacidad legal para entrar en un contrato vinculado, incluidos estos Términos y Condiciones y cualquier apuesta que usted realice;<br />
        d. Está abriendo su cuenta únicamente para uso personal, y está actuando en su propio nombre y no como un agente en nombre de un tercero;<br />
        e. No intentará vender ni de ninguna manera transferir el beneficio de su cuenta a terceros, ni adquirirá ni intentará adquirir una cuenta que se haya abierto a nombre de un tercero;<br />
        f. No tiene prohibido, por ningún motivo, apostar con nosotros o utilizar nuestros servicios; y<br />
        g. Actualmente no está sujeto a una autoexclusión de una cuenta del Sitio y ni nosotros ni ningún otro operador lo ha excluido de los juegos de azar.<br />
        h. Debe mantener su información personal al día. Si no lo hace, es posible que sus apuestas o pagos se rechacen o se emitan de forma incorrecta.<br />
        i. No puede transferir fondos de una cuenta del Sitio a otra bajo ninguna circunstancia.<br />
      </Typography>
      <Typography variant="body2" paragraph>
        5. Si incumple con alguno de los términos del numeral 6 de estos Términos y Condiciones, podrá el Sitio proceder a:
      </Typography>
      <Typography variant="body2" paragraph sx={{ pl: 2 }}>
        a. Podemos cancelar cualquier apuesta que haya realizado;<br />
        b. No estaremos obligados a pagar ninguna ganancia que de lo contrario se hubiera pagado con respecto a cualquier apuesta que haya realizado; y<br />
        c. Podemos referir el asunto a la policía, tutores o miembros de la familia, o cualquier otra autoridad reguladora apropiada.<br />
      </Typography>
      <Typography variant="body2" paragraph>
      ...
      <Typography variant="body2" paragraph>
        21. EL USUARIO acepta el hecho de que XXXTREMO, descuente de la cantidad solicitada en su retiro en concepto de retención, el 1% de impuestos determinado por Legislación vigente en la República Mexicana, por la obtención de ingresos derivados de ganancias en el juego.
      </Typography>
      <Typography variant="body2" paragraph sx={{ pl: 2 }}>
        En caso de cualquier error de retraso o fallo en el juego se considerará como fallo del sistema y se cancelarán las ganancias obtenidas.<br />
        Solo estamos obligados a pagar las ganancias que se han ganado realmente en conformidad con nuestros Términos y Condiciones.<br />
      </Typography>
      <Typography variant="body2" paragraph>
      ...
      <Typography variant="body2" paragraph sx={{ pl: 2 }}>
        I. Una situación en la que exista evidencia de irregularidades en las apuestas, el precio haya sido manipulado, haya tenido lugar el arreglo o amaño de partidos, si se sospecha que un individuo o individuos actúan en forma conspirativa o en conjunto con respecto a una apuesta o;<br />
        II. una situación en la que exista evidencia de que ha violado materialmente estos términos y condiciones, incluso por actuar de manera fraudulenta, ilegal o por participar en actividades inapropiadas (incluidas trampas, colusión o actividades delictivas).<br />
      </Typography>
      <Typography variant="body2" paragraph>
      ...
      <Typography variant="body2" paragraph sx={{ pl: 2 }}>
        (a) para proveerle nuestros servicios;<br />
        (b) para procesar su pago por los productos; y<br />
        (c) si manifestó su acuerdo con esto durante el proceso de registro, para brindarle información sobre productos similares que le proporcionamos, pero puede dejar de recibir esto en cualquier momento al comunicarse con nosotros y, a nuestra entera discreción, podemos dejar de enviarle dichos correos electrónicos. en cualquier momento.<br />
      </Typography>
      <Typography variant="body2" paragraph>
      ...
      <Typography variant="body2" paragraph sx={{ pl: 2 }}>
        Nosotros sólo publicaremos en nuestra pagina y sitios ofíciales el resultado del evento.<br />
        Si ocurriera algún error humano. Del juez o jueces, de los organizadores o personal. Por ejemplo algún cambio de color alguna decisión de fallo así como cualquier tipo de decisión.<br />
        Nosotros no seremos responsables. SI OCURRIERA ALGUNA FALLA, nosotros cuando se restablezca la normalidad repartiremos las ganancias conforme al resultado del evento.<br />
        En casos de fuerza mayor, seguridad, contingencia, errores o decisión de la empresa, nosotros podremos decretar el evento como empate y cancelar cualquier tipo apuesta.<br />
      </Typography>
