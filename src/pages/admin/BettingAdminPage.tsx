...
const BettingAdminPage: React.FC = () => {
  ...
  const getColorStats = (fightId: string, color: 'red' | 'green') => {
    ...
    const totalAmount = colorBets.reduce((sum: number, bet: any) => sum + bet.matchedAmount, 0);
  ...
  if (isLoading) {
    return (
        <Container maxWidth="xl" sx={{ display: 'flex', flexDirection: 'column', alignItems: 'center', minHeight: '100vh', justifyContent: 'flex-start' }}>
